...
$("document").ready(function () {
	  ...
	  $('.info').click(function(){
		 ...
		 url1 = urls[0] + "?" + urls[1] + "&" + "tamano=" + $('#tamano').val() + "&" + "tipo=" + $('#tipo').val() + "&" + "sexo=" + $('#sexo').val();
...
<div class="resultados">
	...
	<?php
		...
		if( empty($_POST['tamano']) && empty($_POST['tipo']) && empty($_POST['sexo']) ){
		$tamano = $_GET['tamano'];
		$tipo = $_GET['tipo'];
		$sexo = $_GET['sexo'];			
		//echo $tipo;
		...
		$strSQL = "SELECT * FROM adopciones WHERE extra='$tipo' AND tamano='$tamano' AND sexo='$sexo'";
		//echo $strSQL;
		...
		echo "<ul class='tags'>
				  <li><a href='#'>".ucfirst($tipo)."</a></li>
				  <li><a href='#'>".ucfirst($tamano)."</a></li>
				  <li><a href='#'>".ucfirst($sexo)."</a></li>
			  </ul>";
