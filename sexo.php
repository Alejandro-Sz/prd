...
$("document").ready(function () {
	  ...
	  $('.info').click(function(){
		 ...
		 url1 = urls[0] + "?" + urls[1] + "&" + "sexo=" + $('#sexo').val();
...
<div class="resultados">
	...
	<?php
		...
		$strSQL = "SELECT * FROM adopciones WHERE sexo='$sexo'";
		//echo $strSQL;
		...
		echo "<div id='numbers1' style='margin-top:1.7em; margin-left:0em; position:absolute'>Total: ".$Num_Rows ."  &nbsp|&nbsp Página :  </div>";	
 ...
 <div class='foto' onclick="window.open('detalles.php?clave=<?php echo $objResult['clave'] ?>');" style="cursor: hand; background-image:url('../fotos_adop/<?php echo $objResult['foto1'] ?>'); background-position:center; background-repeat:no-repeat; background-size:contain;">
	   ...
	   ?>
        ...
        <div id="numbers" style="margin-top:3.6em; margin-left:0em; position:absolute">Total: <?php echo $Num_Rows ?> | Página :  </div>
       <div class="pagin">    
		...
		echo "<input id='sexo' name='sexo' class='txt' type='hidden' value='$sexo' />";
