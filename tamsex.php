...
$("document").ready(function () {
	  ...
	  $('.info').click(function(){
		 ...
		 url1 = urls[0] + "?" + urls[1] + "&" + "tamano=" + $('#tamano').val() + "&" + "sexo=" + $('#sexo').val();
...
<div class="resultados">
	...
	<?php
		...
		if( empty($_POST['tamano']) && empty($_POST['sexo']) ){
		...
		$strSQL = "SELECT * FROM adopciones WHERE tamano='$tamano' AND sexo='$sexo'";
		//echo $strSQL;
 ...
 <div class='foto' onclick="window.open('detalles.php?clave=<?php echo $objResult['clave'] ?>');" style="cursor: hand; background-image:url('../fotos_adop/<?php echo $objResult['foto1'] ?>'); background-position:center; background-repeat:no-repeat; background-size:contain;">
       ...
       <div class="pagin">    
		...
		echo "<input id='tamano' name='tamano' type='hidden' value='$tamano' />"; 
