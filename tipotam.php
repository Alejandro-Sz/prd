...
$("document").ready(function () {
	  ...
	  $('.info').click(function(){
		 ...
		 url1 = urls[0] + "?" + urls[1] + "&" + "tipo=" + $('#tipo').val() + "&" + "tamano=" + $('#tamano').val();
...
<div class="resultados">
	...
	<?php
		...
		if( empty($_POST['tamano']) && empty($_POST['tipo'])){
		$tamano = $_GET['tamano'];
		$tipo = $_GET['tipo'];			
		//echo $tipo;
		//echo $tamano;
		...
		$strSQL = "SELECT * FROM adopciones WHERE extra='$tipo' AND tamano='$tamano'";
		//echo $strSQL;
