...
<body>
  ...
  <!--Cabecera -->
       ...
       <div id="header2">
              ...
              <!--Logos Fb, Tw, YT, Home -->
                 ...
                 <div style="width:100%; height:50%; position:relative; margin-top:0em; margin-left:0%; ">
                           ...
                           <a target="_self" href="http://localhost/prodan_galeria_vfinal/" class="home"></a>
   ...
   <div style=" margin:3em auto; width:80%;background-color: transparent; border: 5px solid transparent; -moz-border-radius: 6px;
...
-ms-filter: "progid:DXImageTransform.Microsoft.gradient(startColorstr = 'transparent', endColorstr = 'transparent')"; background-image: -moz-linear-gradient(top, transparent, transparent); background-image: -ms-linear-gradient(top, transparent, transparent);background-image: -o-linear-gradient(top, transparent, transparent); background-image: -webkit-gradient(linear, center top, center bottom, from(transparent), to(transparent));
background-image: -webkit-linear-gradient(top, transparent, transparent); background-image: linear-gradient(top, transparent, transparent); -moz-background-clip: padding; -webkit-background-clip: padding-box; background-clip: padding-box;opacity: 0.77; -ms-filter: progid:DXImageTransform.Microsoft.Alpha(Opacity = 77); filter: alpha(opacity = 77); ">
     
      <iframe src="http://prodan.org.mx/archivos/AntesDeAdoptar.pdf" width="99.5%" height="700px	">
